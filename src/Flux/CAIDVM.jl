...
function calc_domain_flux(
    ...
    fw =
        micro_to_macro(
            ...
            here_weight,
            vs_data,
        )+micro_to_macro(there_micro, there_mid, there_weight, vs_data)
    ...
    @inbounds @views begin
        ...
        there_df =
            vs_data.df[
                nheavi,
                :,
            ]+(there_ps_mid[direction]-here_ps_mid[direction])*there_sdf[:, :, direction]
...
function calc_flux(
    ...
    fw =
        micro_to_macro(
            ...
            here_weight,
            here_data.vs_data,
        )+micro_to_macro(there_micro, there_mid, there_weight, here_data.vs_data)
    return fw, [here_micro, there_micro]
end
