...
mutable struct Gas <: AbstractGas
    ...
    Pr::Float64
    """
    The translational internal DOF.Default is `1.0`. # for 1-D, K = N+2; for 2-D, K = N+1; for 3-D, K = N; where, N denotes the degree of internal freedom (containing rotational and viberational, etc., but not translational.)
    """
    ...
    """
    Default is `5/3`. # γ=Cₚ/Cᵥ=((N+3)+2)/(N+3). For monotomic gas, N=0 and γ=5/3.
    """
    ...
    μᵣ::Float64
    """
    The reference temperature of the molecular model. Default is `1.0`. # The reference temperature of the molecular model
    """
